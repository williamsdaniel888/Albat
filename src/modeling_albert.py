...
# Contains code contributions by Google AI, Google Brain and the HuggingFace Inc. team.
# 
    ...
    def forward(
        ...
        for i in range(self.config.num_hidden_layers):
            ...
            layer_group_output = self.albert_layer_groups[group_idx](
                hidden_states,
                attention_mask,
                None,#head_mask[group_idx * layers_per_group : (group_idx + 1) * layers_per_group],
                output_attentions,
...
#        self.pooler_activation = nn.Tanh()
    ...
    Return:
        ...
        pooled_output = self.pooler(sequence_output) #self.pooler_activation(self.pooler(sequence_output[:, 0]))
